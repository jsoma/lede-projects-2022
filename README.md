...
|url|mobile|medium|wide|
|---|---|---|---|
|[Unicorn! · GitHub](https://danielle-li.github.io/climbing-routes/)<br>:x: og:title<br>:x: og:description<br>:x: og:image<br>[how to fix](tips/SOCIAL.md)|request failed|request failed|request failed|
...
|url|mobile|medium|wide|
|---|---|---|---|
|[Unicorn! · GitHub](https://gabrielacarrasquillo.github.io/beachfronts/project-website/)<br>:x: og:title<br>:x: og:description<br>:x: og:image<br>[how to fix](tips/SOCIAL.md)|request failed|request failed|request failed|
