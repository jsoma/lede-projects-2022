...
|url|mobile|medium|wide|
|---|---|---|---|
|[Will Adopting Apps Reverse Singapore's Taxi Shortage?](https://yikchun-l.github.io/project-01/)<br>:x: og:title<br>:x: og:description<br>:x: og:image<br>[how to fix](tips/SOCIAL.md)|request failed|request failed|request failed|
